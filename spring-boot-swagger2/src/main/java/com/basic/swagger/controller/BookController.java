package com.basic.swagger.controller;
 ...
 * @Date 19/01/04
 */
import com.basic.swagger.entity.Book;
...
public class BookController {
    ...
    @ApiOperation(value="获取图书信息", notes="根据url的id来获取详细信息")
    ...
    /**
     * @Description: @ApiIgnore ：使用该注解忽略这个API
     * @param:  * @param
